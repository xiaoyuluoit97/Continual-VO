...
DELTA_DIM = 3
ESUME_TRAINR = False
TRAIN = "ACT_naive_test_"
RESUME_PATH = "log/act_naive"
TIMES="0"
RESUME_FILE = "ACT_naive_Exp38_resume5time.pth"
...
class CustomSavePlugin(PluginMetric):
    ...
    def after_training_exp(self, strategy: 'PluggableStrategy'):
        ...
        save_path = os.path.join(RESUME_PATH,
                                 "{}Exp{}_resume{}time.pth".format(TRAIN, str(strategy.experience.current_experience),TIMES))
        # 保存模型
