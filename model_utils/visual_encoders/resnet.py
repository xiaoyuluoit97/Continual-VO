...
def vit16(in_channels, base_planes, ngroups):
...
def resnet101(in_channels, base_planes, ngroups):
    ...
    return model
def resnet152(in_channels, base_planes, ngroups):
    model = ResNet(in_channels, base_planes, ngroups, Bottleneck, [3, 4, 36, 3])
    return model
